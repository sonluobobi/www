...
class CoinDozerService extends Base
{
	public $sign = 'coin_dozer';
	public $tbl_coin_dozer_base = 'coin_dozer_base';
	public $tbl_coin_dozer_detail = 'coin_dozer_detail';
	...
	public function getBaseAndDetail($ids_arr)
	{
		...
		$tbl_coin_dozer_base = $this->tbl_coin_dozer_base;
		$tbl_coin_dozer_detail = $this->tbl_coin_dozer_detail;
		...
		$act_result = $db->select($tbl_coin_dozer_base, '*', $cond);
		...
		if (!empty($act_result))
		{
			...
			$act_item_result = $db->select($tbl_coin_dozer_detail, '*', $cond_item);
