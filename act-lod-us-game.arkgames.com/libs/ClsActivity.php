...
class ClsActivity {
	...
	//表字段
	var $tbl_activity_fields = array ( 'id', 'activity_sort_id', 'is_long_term','title', 'character_level',
	                                   'interfix_npc_id', 'interfix_npc', 'start_time', 'end_time',
	                                    'server_ids', 'intro', 'is_view_act', 'res_id',
