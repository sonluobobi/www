...
* @version    CVS: $Id: PHPExcelReader.php 27694 2012-08-20 14:36:58Z cyz $
 ...
 * include "reader.php";
 * $EXCLE = new Spreadsheet_Excel_Reader();
 * $EXCLE->setOutputEncoding('UTF-8');
 * $EXCLE->setUTFEncoder('mb');
 * $EXCLE->read('b.xls');
 * print_r($EXCLE->sheets);
 */
?>
