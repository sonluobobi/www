var faisunMenu_openedfolderimage_src="js/menutree/openedfolder.gif";
var faisunMenu_closedfolderimage_src="js/menutree/closedfolder.gif";
var faisunMenu_menufileimage_src="js/menutree/menufile.gif";
...
function createtree(){
  ...
  for(i=0;i<faisunMenu_treetext.length;i++){
	...
	for(j=1;j<subnum;j++){
	  echo += "<td width='20' valign=bottom><img src='js/menutree/"+(openedlayer[j]?"bar3.gif":"spacer.gif")+"' width='20' height='20'></td>\n";
	}
	if(subnum>0){
	  echo += "<td width='20' valign=bottom><img src='js/menutree/bar"+barstatus+".gif' width='20' height='20'></td>";
	}
