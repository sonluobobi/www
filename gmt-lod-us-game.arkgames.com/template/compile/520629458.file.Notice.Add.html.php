...
：</td>  
	<td align="left"><select name="cycle" id="cycle" onchange="changePopNotice(this.value,'NoticeDIV')">  
						...
						<option value="360" <?php if ($_smarty_tpl->getVariable('cycle')->value=='360'){?>selected="true"<?php }?>>6分钟</option>
						<option value="420" <?php if ($_smarty_tpl->getVariable('cycle')->value=='420'){?>selected="true"<?php }?>>7分钟</option>
						<option value="480" <?php if ($_smarty_tpl->getVariable('cycle')->value=='480'){?>selected="true"<?php }?>>8分钟</option>
						<option value="540" <?php if ($_smarty_tpl->getVariable('cycle')->value=='540'){?>selected="true"<?php }?>>9分钟</option>
						<option value="600" <?php if ($_smarty_tpl->getVariable('cycle')->value=='600'){?>selected="true"<?php }?>>10分钟</option>
						<option value="900" <?php if ($_smarty_tpl->getVariable('cycle')->value=='900'){?>selected="true"<?php }?>>15分钟</option>
						<option value="1200" <?php if ($_smarty_tpl->getVariable('cycle')->value=='1200'){?>selected="true"<?php }?>>20分钟</option>
...
：</td>  
	<td align="left"><input type="text" name="tollgate_id" value="<?php echo $_smarty_tpl->getVariable('tollgate_id')->value;?>
" id="tollgate_id" style="width:200px" /></td>  
</tr>
...
&nbsp;
	...
	<div style="width:50%;margin:auto;">
		<button  type="button" onclick="adding()">新增一行</button>&nbsp;&nbsp;
	</div>
