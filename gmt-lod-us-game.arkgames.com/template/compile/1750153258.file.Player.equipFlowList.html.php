...
<div class="bodyContent"  style="border-top: 2px solid #666;">
  ...
  <div class="bodyContentHead" style="text-align:center">
	<form method="POST" name="myform" id="myform" action="./?act=Player.getEquipFlowList" onsubmit="pageGo(1);return false;">
...
：<select name="source_direct" id="source_direct">
	<?php $_smarty_tpl->assign('source_direct_v',$_REQUEST['source_direct'],null,null);?>
		<option value="0"><?php echo $_smarty_tpl->getVariable('lang')->value['plaseClew'];?>
</option>
...
<div class="bodyContentHead" style="color:red;">
</div>
<div class="bodyContentHead" style="color:red;">
</div>
		...
		<thead>
			<tr>
              ...
              <th><?php echo $_smarty_tpl->getVariable('lang')->value['accountId'];?>
</th>
			  <th><?php echo $_smarty_tpl->getVariable('lang')->value['sourceDirect'];?>
</th>
              <th><?php echo $_smarty_tpl->getVariable('lang')->value['op_id'];?>
</th>
			  <th><?php echo $_smarty_tpl->getVariable('lang')->value['awardSource'];?>
</th>
			  <th><?php echo $_smarty_tpl->getVariable('lang')->value['targetNick'];?>
</th>
              <th><?php echo $_smarty_tpl->getVariable('lang')->value['targetCid'];?>
</th>
			  <th><?php echo $_smarty_tpl->getVariable('lang')->value['scene_id'];?>
</th>
...
?>
		<tr>
			  ...
			  <td>	
			  	<?php if ($_smarty_tpl->getVariable('dataList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['ii']['index']]['is_get']==1){?> <?php echo $_smarty_tpl->getVariable('lang')->value['sourceGet'];?>

			  	<?php }else{  echo $_smarty_tpl->getVariable('lang')->value['sourceLose'];?>

			  	<?php }?>
			  	
			  </td>
			  <td><?php echo $_smarty_tpl->getVariable('dataList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['ii']['index']]['op_title'];?>
</td>
			  <td><?php echo $_smarty_tpl->getVariable('dataList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['ii']['index']]['reward_module_title'];?>
</td>
			  <td><?php echo $_smarty_tpl->getVariable('dataList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['ii']['index']]['slave_nick'];?>
</td>
	          <td><?php echo $_smarty_tpl->getVariable('dataList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['ii']['index']]['slave_cid'];?>
</td>
			  <td><?php echo $_smarty_tpl->getVariable('dataList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['ii']['index']]['scene_id'];?>
</td>
			  <td><?php echo $_smarty_tpl->getVariable('dataList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['ii']['index']]['created'];?>
</td>
			  <td><?php echo $_smarty_tpl->getVariable('dataList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['ii']['index']]['params'];?>
</td>
        </tr>
		<?php endfor; endif; ?>
		</tbody>
